                ...
                <form method="post" id="registrationForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <p>Kies hier altijd je eigen inkomen, als je met een partner wilt huren kies je later voor
                                'Met
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="password" class="form-control" id="partner_wachtwoord"
                                   name="partner_wachtwoord"
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="date" class="form-control" id="partner_geboortedatum"
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <p>Kies hier altijd je eigen inkomen. Dat van je partner is eerder al opgegeven. Deze worden
                                bij
                    ...
                    if($options['reAgency_field_sandbox'] == 'enabled') {
                        ?>
